...
const LoginForm = () => {
   ...
   const isDisabled = !login.trim() || !password.trim();
    ...
    const handleSubmit = async (e) => {
        ...
        const success = await getUserInfo(login.trim(), password.trim()); 
        (rememberMe && success) 
        ? localStorage.setItem('rememberUser',JSON.stringify({login, password}))
            ...
            <div className="userData">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="avs">
                        ...
                        <label htmlFor="cbx" className="remember-user">Запомнить?</label>
                        <Link 
                            to="/forgotPassword" 
                            style={{
                                display: 'block',
                    ...
                    <button type="submit" className="sign-in" disabled={isDisabled}>
                        sign in
                    </button>
                    ...
                    <div className="another-entrance">
                        ...
                        <a href="https://google.com" className="social-btn google">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
